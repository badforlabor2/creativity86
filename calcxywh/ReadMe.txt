========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : calcxywh
========================================================================


AppWizard has created this calcxywh application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your calcxywh application.
...
calcxywh.h
    ...
    CCalcxywhApp application class.
...
res\calcxywh.ico
    ...
    icon is included by the main resource file calcxywh.rc.
...
calcxywhDlg.h, calcxywhDlg.cpp - the dialog
    These files contain your CCalcxywhDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in calcxywh.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CCalcxywhDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named calcxywh.pch and a precompiled types file named StdAfx.obj.
